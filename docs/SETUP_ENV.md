...
- Keep office credentials only in this project. Current local snapshot lives in `secrets/office.credentials.local.md`.
- Never point another project to `speeuvmq_speednet_office` or reuse `speeuvmq_speeuvmq`.
