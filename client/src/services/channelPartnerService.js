...
export const getUserPayments = async (resellerId, month) =>
  (await apiClient.get(`${base}/${resellerId}/user-payments`, { params: { month } })).data;

export const initMonthlyPayments = async (resellerId, month) =>
  (await apiClient.post(`${base}/${resellerId}/user-payments/init`, { month })).data;

export const recordUserPayment = async (resellerId, payload) =>
  (await apiClient.post(`${base}/${resellerId}/user-payments/record`, payload)).data;

export const bulkRecordPayments = async (resellerId, month, payments) =>
  (await apiClient.post(`${base}/${resellerId}/user-payments/bulk`, { month, payments })).data;

// Commission
export const getCommissionSummary = async (resellerId, month) =>
  (await apiClient.get(`${base}/${resellerId}/commission-summary`, { params: { month } })).data;

export const generateCommission = async (resellerId, month) =>
  (await apiClient.post(`${base}/${resellerId}/commission-generate`, { month })).data;

export const adjustCommission = async (resellerId, logId, payload) =>
  (await apiClient.patch(`${base}/${resellerId}/commission/${logId}/adjust`, payload)).data;

export const finalizeCommission = async (resellerId, logId) =>
  (await apiClient.patch(`${base}/${resellerId}/commission/${logId}/finalize`)).data;
...
export const recordCommissionPayment = async (resellerId, payload) =>
  (await apiClient.post(`${base}/${resellerId}/commission-payments`, payload)).data;
