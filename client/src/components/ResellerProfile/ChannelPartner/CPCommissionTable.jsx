    ...
    <div className="table-responsive">
      <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
        ...
        <tbody>
          ...
          {/* ⑨ নেট কমিশন — shown only when prev balance exists */}
          {prevBal !== 0 && (
          ...
          {/* ⑪ মোট প্রদেয় — show total payable, then subtract paid if any */}
          {paid > 0 ? (
            <>
              <tr style={{ background: '#f8fafc', borderTop: '2px solid #cbd5e1' }}>
                <td style={{ ...td, fontWeight: 700, borderTop: '2px solid #cbd5e1' }}>মোট প্রদেয় (Total Payable)</td>
                <td style={{ ...tdCount, borderTop: '2px solid #cbd5e1' }}>—</td>
                <td style={{ ...tdAmt, fontSize: '0.97rem', fontWeight: 700, borderTop: '2px solid #cbd5e1' }}>{fmt(totalPayable)}</td>
              </tr>
              <tr>
