...
const UnderConstruction = () => (
  <div className="d-flex flex-column justify-content-center align-items-center vh-100">
    <h2 className="text-warning"><i className="fas fa-tools me-2"></i>{t('app.underConstructionTitle')}</h2>
    <p className="text-muted">{t('app.underConstructionText')}</p>
    <a href="/" className="btn btn-primary mt-3">{t('app.backToDashboard')}</a>
  </div>
);
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            <Route element={<Layout />}>
              {protectedRouteConfig.map((r) => <Route key={r.path} path={r.path} element={routeElementByKey[r.key]} />)}
            </Route>
          </Route>
          ...
          <Route path="*" element={
            <div className="d-flex flex-column justify-content-center align-items-center vh-100">
              ...
              <a href="/" className="btn btn-primary mt-3">{t('app.goHome')}</a>
            </div>
          }
          />
        </Routes>
