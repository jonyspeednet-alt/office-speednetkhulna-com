  ...
  const load = async () => {
    ...
    try {
      ...
      setEditForm({
        ...
        next_pay_date: r.next_pay_date ? String(r.next_pay_date).slice(0, 10) : '',
        security_deposit: Number(r.security_deposit || 0),
        joining_date: r.joining_date ? String(r.joining_date).slice(0, 10) : (r.created_at ? String(r.created_at).slice(0, 10) : '')
      });
    } catch (e) {
      setData(null);
